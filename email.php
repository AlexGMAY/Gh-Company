                                                                              ...
                                                                              <tbody>
                                                                                  <tr style="border-collapse: collapse;">
                                                                                      <td align="center" style="padding: 0; margin: 0; font-size: 0px;">
                                                                                          <img
                                                                                              src="https://i.imgur.com/z9dQaBe.png"
                                                                                              alt=""
                                                                                                ...
                                                                                                <tr style="border-collapse: collapse;">
                                                                                                    <td align="left" style="margin: 0; padding-left: 10px; padding-right: 10px; padding-top: 30px; padding-bottom: 30px;">
                                                                                                        <p
                                                                                                            ...
                                                                                                            "
                                                                                                        >
                                                                                                            <strong style="font-size: 20px;">   Bonjour '.$_REQUEST['nom'].' </strong>
                                                                                                            <br />
                                                                                                            <p style="line-height: 3;">
                                                                                                           <strong>E-mail :</strong> '.$_REQUEST['email'].'<br />
                                                                                                            <strong>Besoin :</strong> ';
                                                                                                            if(!empty($_REQUEST['besoin'])){
                                                                                                                foreach($_REQUEST['besoin'] as $selected){
                                                                                                                    $message .=  $selected." , ";
                                                                                                                }
                                                                                                            }
                                                                                                            $message .= '<br />
                                                                                                            <strong>Numéro de téléphone :</strong> '.$_REQUEST['tel'].'<br />
                                                                                                            <strong>Sujet :</strong> '.$_REQUEST['sujet'].'<br />
...
$to = 'contact@ghcocompany.com';

$subject = 'Contact GHcompany';
...
//Receive Variable
/*$mail->From = 'GH Company';
$mail->FromName = 'GH Company';
$mail->AddAddress($_REQUEST['email'], $_REQUEST['nom']);  // Add a recipient
$mail->AddAddress('contact@ghcocompany.com', 'GH Company');
$mail->CharSet = 'UTF-8';
$mail->IsHTML(true);
$mail->Subject = 'Contact GHcompany';
$mail->Body    = $message;
$mail->AltBody = 'Contact GHcompany';
$mail->Send();*/
